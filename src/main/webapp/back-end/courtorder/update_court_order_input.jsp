...
<title>員工資料修改 - update_court_order_input.jsp</title>
...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h3>訂單資料修改 - update_court_order_input.jsp</h3>
				<h4>
	...
	<FORM METHOD="post"
		...
		<table>
			<tr>
				<td>場館訂單編號:<font color=red><b>*</b></font></td>
			...
			<tr>
				...
				<td><select name="reservationStatus">
						<option value="true"
							${courtOrderVO.reservationStatus ? 'selected' : ''}>有效</option>
						<option value="false"
							${courtOrderVO.reservationStatus ? '' : 'selected'}>取消</option>
				</select></td>
			</tr>
			<tr>
				<td>訂單建立日期:</td>
			...
			<tr>
				...
				<td><select name="rating">
						...
						<option value="1" ${courtOrderVO.rating == 1 ? 'selected' : ''}>1星</option>
						<option value="2" ${courtOrderVO.rating == 2 ? 'selected' : ''}>2星</option>
						<option value="3" ${courtOrderVO.rating == 3 ? 'selected' : ''}>3星</option>
						<option value="4" ${courtOrderVO.rating == 4 ? 'selected' : ''}>4星</option>
						<option value="5" ${courtOrderVO.rating == 5 ? 'selected' : ''}>5星</option>
				</select></td>
			</tr>
...
<%
// 確認是否進入了頁面
System.out.println("Debug: update_emp_input.jsp 已加載");
%>
